export default {
  ...
  'app.settings.security.userPassword': '賬戶密碼',
  'app.settings.security.userPassword-description': '當前密碼強度',
  ...
  'app.settings.notification.userPassword': '賬戶密碼',
  'app.settings.notification.userPassword-description': '其他用戶的消息將以站內信的形式通知',
